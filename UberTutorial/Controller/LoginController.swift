...
class LoginController: UIViewController {
    ...
    let dontHaveAccountButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "Don't have an accaunt?", attributes:
    ...
    func configureUI() {
        ...
        let stack = UIStackView(arrangedSubviews: [passwordContainerView, emailContainerView, loginButton])
        stack.axis = .vertical
