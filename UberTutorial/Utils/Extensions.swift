...
extension UIColor {
    ...
    static let trackStrockeColor = UIColor.rgb(red: 56, green: 25, blue: 49)
    static let pulsatingFillColor = UIColor.rgb(red: 86, green: 30, blue: 43)
}

extension UIView {
    
    func inputContainerView(imageName: String,
